...
shipped games and Acerola's grass and fur series draw vegetation. Nothing in
this document is built. Its place in the set is
...
| ---- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- | ------------------------------ |
| G1   | The field description, tiles, deterministic placement, compute generation into fixed slots, the grass pass lit through a guarded copy of the light walk; card grass with cooked coverage mips; wind lean | one compute dispatch per tile; one draw per slot  | W1 of [56-wind.md](56-wind.md) |
