...
bootDemo({
  init,
  hint: 'W/A/S/D walk, relative to where you are looking · click to take the pointer, then the mouse looks · the arrows look too · SPACE fires · I opens the kit · ESC opens the panel · F3 shows the stats · F11 fullscreen',
  savedLabel: 'Nothing',
  bind: (ex) => {
