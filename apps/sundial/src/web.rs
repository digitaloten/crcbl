...
//! which are the table below. The symbol names stay here too, written out one
...
//!
//! `__crcbl_sundial_` is this module's prefix. **What each of the ten
...
//!
//! [`__crcbl_sundial_prepare`], [`__crcbl_sundial_log_level`],
//! [`__crcbl_sundial_boot`], [`__crcbl_sundial_frame`],
//! [`__crcbl_sundial_status`], [`__crcbl_sundial_shutdown`],
//! [`__crcbl_sundial_error_ptr`], [`__crcbl_sundial_error_len`],
//! [`__crcbl_sundial_log_take`], [`__crcbl_sundial_log_ptr`].
//!
//! ## Exports: the knobs
//!
