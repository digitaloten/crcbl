...
//! outstanding**: the buffer clear was the last one, and it landed as a copy out
//! of the device's zeroed resource, so every remaining
...
//! rather than a slice to wait for. The
